...
internal static class LocalizationService
{
    private static readonly Dictionary<string, Dictionary<string, string>> _resources = new(StringComparer.OrdinalIgnoreCase)
    {
        ["en"] = new()
        {
            ...
            ["SettingAIDesc"] = "Configure OpenRouter free LLM access. Prefix query with (-) to ask anything.",
            ["SettingAIProviderTitle"] = "AI Provider",
            ["SettingAIProviderDesc"] = "Choose between the default free router or a custom API key.",
            ["SettingModelTitle"] = "AI Model",
            ["SettingModelDesc"] = "Select which model to use.",
            ["AiProviderFree"] = "Free Models Router",
            ["AiProviderCustom"] = "Custom API Key",
            ...
            ["AiAssistantSubtitle"] = "Powered by OpenRouter • Free",
        ...
        ["ar"] = new()
        {
            ...
            ["SettingAIDesc"] = "تكوين وصول OpenRouter المجاني لنموذج اللغة (LLM). ابدأ البحث بـ (-) للسؤال عن أي شيء.",
            ["SettingAIProviderTitle"] = "مزود الذكاء الاصطناعي",
            ["SettingAIProviderDesc"] = "اختر بين موجه النماذج المجاني أو مفتاح API مخصص.",
            ["SettingModelTitle"] = "نموذج الذكاء الاصطناعي",
            ["SettingModelDesc"] = "اختر النموذج الذي ترغب في استخدامه.",
            ["AiProviderFree"] = "موجه النماذج المجاني",
            ["AiProviderCustom"] = "مفتاح API مخصص",
            ...
            ["AiAssistantSubtitle"] = "مدعوم من OpenRouter • مجاني",
